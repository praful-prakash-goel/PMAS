...
# ============================================================
# SEQUENCE CREATION (LONGER WINDOW)
# ============================================================
...
def load_data(data_path = DATA_PATH):   
    ...
    return healthy_sequences, full_sequences, df

# ============================================================
# TRAIN SETUP
# ============================================================

def train_model(healthy_sequences):
...
def get_machine_status(model, healthy_sequences, full_sequences):
    # ============================================================
...
def plot_graphs(df, recon_errors):
...
if __name__ == '__main__':
    healthy_sequences, full_sequences, df = load_data(data_path=DATA_PATH)
    model = train_model(healthy_sequences)
    recon_errors = get_machine_status(model, healthy_sequences, full_sequences)
    plot_graphs(df, recon_errors)